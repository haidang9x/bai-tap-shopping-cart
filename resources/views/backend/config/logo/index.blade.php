                            ...
                            <div class="text-sm-left">
                                <a href="{{ route('logo.create') }}"
                                    class="btn btn-success btn-rounded waves-effect waves-light mb-2 mr-2"><i
                                        class="mdi mdi-plus mr-1"></i>Thêm mới Logo</a>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <table id="datatable-buttons"
                                class="table table-bordered  nowrap dataTable no-footer dtr-inline table-hover"
                                ...
                                <tbody>
                                    @foreach ($logos as $logo)
                                        <tr>
                                            ...
                                            <td class="sorting_1"><img src="{{ asset('/uploads/'. $logo->value) }}" alt="" width="100px"></td>
